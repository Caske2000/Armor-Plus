...
public final class ModItems {
    private static final ItemArmor.ArmorMaterial IRONMat = EnumHelper.addArmorMaterial("IRONMat", "commutablearmor:ironmat", 15, new int[]{2, 6, 5, 2}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f);
    ...
    private static final ItemArmor.ArmorMaterial DIAMONDMat = EnumHelper.addArmorMaterial("DIAMONDMat", "commutablearmor:diamondmat", 33, new int[]{3, 8, 6, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.0f);
    ...
    private static final ItemArmor.ArmorMaterial ALLOYMat = EnumHelper.addArmorMaterial("ALLOYMat", "commutablearmor:alloymat", 50, new int[]{3, 8, 6, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0f);
