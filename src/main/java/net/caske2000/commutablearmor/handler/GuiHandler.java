...
import net.caske2000.commutablearmor.client.gui.GuiArmorCharger;
import net.caske2000.commutablearmor.client.gui.GuiArmorTable;
import net.caske2000.commutablearmor.client.gui.manual.GuiManual;
