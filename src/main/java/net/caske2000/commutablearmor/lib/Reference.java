package net.caske2000.commutablearmor.lib;
...
public final class Reference {
    public static final String MODID = "commutablearmor";
    public static final String MODNAME = "Commutable Armor";
    public static final String VERSION = "0.1.3";
    public static final String ACCEPTED_MC_VERSIONS = "[1.10.2]";


    public static final String CLIENTPROXY = "net.caske2000.commutablearmor.proxy.ClientProxy";
    public static final String SERVERPROXY = "net.caske2000.commutablearmor.proxy.ServerProxy";
