package net.caske2000.commutablearmor;

import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import net.caske2000.commutablearmor.achievements.ArmorAchievements;
import net.caske2000.commutablearmor.client.gui.manual.GuiItemInfo;
import net.caske2000.commutablearmor.lib.Reference;
import net.caske2000.commutablearmor.proxy.CommonProxy;
...
public class CommutableArmor {
    public static VersionChecker versionChecker;
    public static boolean isWarnedVersionOutOfDate = false;

    @Mod.Instance
    public static CommutableArmor instance;
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        try {
            br = new BufferedReader(new InputStreamReader(getClass().getClassLoader()
                    .getResourceAsStream("assets/commutablearmor/lang/manual_" + FMLCommonHandler.instance().getCurrentLanguage() + ".json"), "UTF-8"));
            if (!br.ready())
                br = new BufferedReader(new InputStreamReader(getClass().getClassLoader().getResourceAsStream("assets/commutablearmor/lang/manual_en_US.json"), "UTF-8"));
