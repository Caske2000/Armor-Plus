...
import net.caske2000.commutablearmor.items.ItemArmorUpgrade;
import net.caske2000.commutablearmor.items.ItemCustomArmor;
import net.caske2000.commutablearmor.lib.ArmorTableRecipes;
...
public class TileEntityArmorTable extends TileEntityLockable implements ITickable, IInventory {
    ...
    public String getGuiID() {
        return "commutablearmor:armorTable";
    }
