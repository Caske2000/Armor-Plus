...
import net.caske2000.commutablearmor.handler.EventHandler;
import net.caske2000.commutablearmor.handler.GuiHandler;
import net.caske2000.commutablearmor.items.ArmorRecipe;
...
public class CommonProxy {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(CommutableArmor.instance, new GuiHandler());
        ...
        // Crafting recipes
        RecipeSorter.register("commutablearmor:armorrecipe", ArmorRecipe.class, RecipeSorter.Category.SHAPED, "after:minecraft:shaped");
